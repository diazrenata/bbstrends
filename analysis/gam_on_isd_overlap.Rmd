...
ibd <- readRDS("~/Documents/GitHub/BBSsize/analysis/isd_data/ibd_isd_bbs_rtrg_19_35.Rds")
...
isd_gams_all <- gam(density ~ s(log_size, k = 20) + s(log_size, by = fiveyrsf, k = 5), data = isd_smooths, family = "tw")
...
s_pdat <- filter(isd_pdat, fiveyrsf %in% c(1,5)) %>%
